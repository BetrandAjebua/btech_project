...
<div class="r-password">
  ...
  <select id="b-select" name="m_status">
      <option class="bg-gradient-danger text-white" value="Maried">Married</option>
      <option class="bg-gradient-danger text-white" value="Single">Single</option>
  </select>
  </div>
...
<!--Alert Box-->
<div class="hidden-submit text-center" style="display: none; position: absolute bg-gradient-danger text-white; top: 23em;">
