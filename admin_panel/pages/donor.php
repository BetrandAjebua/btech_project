    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Interface Settings</h5>
          <p>Panel Options</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Side-Nav Type</h6>
        ...
        <p class="text-sm d-xl-none d-block mt-2">Option Possible for Desktop Only</p>
        <!-- Navbar Fixed -->
